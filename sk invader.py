...
# background image
main_screen = pygame.image.load("background2.jpg")
mainscreen = pygame.transform.scale(main_screen,(750,650)).convert_alpha()
homebg = pygame.image.load("background.png")
gameover = pygame.image.load("background2.jpg")
homebgimage = pygame.transform.scale(homebg,(750,650)).convert_alpha()
gameover_screen = pygame.transform.scale(gameover,(750,650)).convert_alpha()
